...
public class Staticvar {
    ...
    public static final String DOM = "http://javafoundation.id/";
    ...
    public static final String PRODUCTHOME = DOMAIN+API+"produk/home";
    ...
    public static final String FILTERLOCATION = DOMAIN+API+"filter/location";
    public static final String FILTERBYLOCATION = DOMAIN+API+"filter/location/";
    ...
    public static final String DESK_BERITA_KOIN_NU = "desk_berita_koin_nu";
    public static final String TGL_BERITA_KOIN_NU = "tgl_berita_koin_nu";
    public static final String PUBLISHING_KOIN_NU = "publishing_koin_nu";
    public static final String JUDUL_BERITA_KOIN_NU = "judul_berita_koin_nu";
    public static final String ID_BERITA_KOIN_NU = "id_berita_koin_nu";
    ...
    public static String ID_USER_PEMBELI = "id_user_pembeli";
    public static String ID_FEEDBACK = "id_feedback";
    public static String KOMEN = "komen";
